...
const INSTITUTE = {
  ...
  director: "Amin",
  meetLink: "https://meet.google.com/xxx-xxxx-xxx",   // fallback if a batch has no link
  verifyBase: "https://learningcomputech-sys.github.io/CEC",
  idPrefix: "BA",
  brochureUrl: "https://drive.google.com/file/d/1fMKt5Q3Ov1fmSweljgFdcKK0QRg70i4m/view?usp=drive_link"
};

/* Admin password (hashed). Default = admin123. Change it in Settings. */
const ADMIN_HASH = "240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9";

/* Each batch has its own Google Meet link. A student's Join buttons
   use the link of the batch they belong to. Manage in the Batches tab. */
const BATCHES = [
  { name: "Morning — Jul 2026", meetLink: "https://meet.google.com/xxx-xxxx-xxx" },
  { name: "Evening — Jul 2026", meetLink: "https://meet.google.com/yyy-yyyy-yyy" }
];

const WELCOME = {
  enabled: true,
  title: "Welcome to your BA batch 👋",
  message: "Classes are live Monday to Friday. Missed a session? Check the Recordings tab. Questions anytime on the batch WhatsApp group.",
  showMeet: true
};
...
const STUDENTS = {
  "BA2026001": {
    name: "Priya Sharma", batch: "Morning — Jul 2026", email: "priya@example.com",
    joined: "08 Jul 2026", progress: 68,
    certId: "CEC-BA-2026-0001", certDate: "15 Aug 2026", certReady: true,
    pass: "demo123"
  },
  "BA2026002": {
    name: "Rahul Kumar", batch: "Evening — Jul 2026", email: "rahul@example.com",
    joined: "08 Jul 2026", progress: 42,
...
const SYLLABUS = [
  { code:"01", color:"#217a56", name:"Advanced Excel",
...
const RECORDINGS = [
  { module:"Advanced Excel", items:[
    { title:"Day 1 — Lookup functions", date:"08 Jul 2026", dur:"1:12:40", fileId:"" },
    { title:"Day 2 — SUMIFS & logic", date:"10 Jul 2026", dur:"58:20", fileId:"" },
    { title:"Day 3 — Pivot tables & Power Query", date:"11 Jul 2026", dur:"1:05:10", fileId:"" }
  ]},
  { module:"SQL & Databases", items:[
    { title:"Day 4 — SELECT & filtering", date:"14 Jul 2026", dur:"1:08:00", fileId:"" },
    { title:"Day 5 — JOINs & GROUP BY", date:"15 Jul 2026", dur:"1:15:30", fileId:"" }
  ]},
  { module:"Power BI", items:[
    { title:"Day 6 — Data modelling & DAX", date:"18 Jul 2026", dur:"1:20:00", fileId:"" }
  ]}
];
...
const SCHEDULE = [
  { day:"Mon", dd:"Live", title:"SQL — JOINs deep dive", time:"7:30 AM / 8:00 PM", meet:true },
  { day:"Tue", dd:"Live", title:"Power BI — DAX measures", time:"7:30 AM / 8:00 PM", meet:true },
  { day:"Wed", dd:"Live", title:"Tableau — dashboards", time:"7:30 AM / 8:00 PM", meet:true },
  { day:"Thu", dd:"Live", title:"AI tools for analysts", time:"7:30 AM / 8:00 PM", meet:true },
  { day:"Fri", dd:"Live", title:"Project workshop", time:"7:30 AM / 8:00 PM", meet:true }
];

const ANNOUNCEMENTS = [
  { title:"New batch starts 8th July", body:"Morning (7:30 AM) and Evening (8:00 PM) slots available. Seats are limited.", time:"2 days ago" },
  { title:"Assignment 3 due Friday", body:"Submit the Power BI dashboard task before the Friday live class.", time:"4 days ago" },
  { title:"Recorded videos — lifetime access", body:"Optional recorded videos add-on gives you lifetime access. Ask your instructor.", time:"1 week ago" }
];
